...
\begin{abstract}
  ...
  In this paper, we show, through a combinatorial upper-bound, that an approximation algorithm for another degree-based spanning-tree optimization problem is also an approximation for \emph{minimum branch vertices}.
  In fact, it is the best known approximation for general graphs and, based on the assumption that \emph{P $\neq$ NP}, it is the best possible for some classes of graphs.
\end{abstract}
